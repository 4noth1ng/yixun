    ...
    <div class="divd" style="overflow: visible;">
        ...
        color: #1989fa;
            ...
            <div class="tabnav_header">
                ...
                <div class="tabheader" @click="godeliver" style="border-bottom: 3px solid #6aa2e4;color:#6aa2e4;">投递记录
                </div>
                <div class="tabheader" @click="goCollect">我的收藏</div>
            </div>
            <div class="tabnav_footer">
                <div class="footer_title">投递记录</div>
                <div class="footer_detail">
                    <div class="footerdetail" v-for="(item, index) in deliver" :key="index"
                        ...
                        <a>
                            ...
                            <div class="footerdetail_introduce">项目ID：{{ item.projectId }}</div>
                        </a>
                    </div>
                </div>
            </div>
...
export default {
    ...
    mounted() {
        requests.get(`/yixun/delivery/getdelivery/${parseInt(localStorage.getItem('userid'))}`)
            .then(res => {
...
.tabnav_header .tabheader:nth-child(3) {
    border-bottom: 3px solid #6aa2e4;

}

.tabnav_header .tabheader:nth-child(3) a {
    color: #6aa2e4;
}
